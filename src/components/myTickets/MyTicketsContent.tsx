...
export const MyTicketsContent = () => {
  const tickets = [
    ...
    },
    {
      ...
      ticketType: 'VIP Pass',
      imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCzumrYf-9gzsqzwUiIvqgIIO6eoqEglB11fMZMTSRjseNSr0z5U5cuCdKx2OTNAwewm3v41ESNH1EWK-vEhz2gc30_cL6faTVgFgvmDR8fF8eMI5kwJUxnLhm6LkHwCXm7nZI8pYHGjzF5xapP180SNRlXGNW25MMiuAxH5lWFAYgfLILIJsPVp3EAg2iV_fyy-JPzCDvEEt_UFBjoaiLNRQNoqmJkrJ_7ZIsqP3yGUyV1ggoqRWmUX56i_WJiXyY11n-9L06AUg',
      ...
      <main className={`${styles.mainContent} ${styles.floatUp}`}>
        <div className={styles.contentWrapper}>
          <div className={styles.headerSection}>
            ...
            <p className="subtitle">All your upcoming events in one place.</p>
          </div>
